...
import { LayoutDashboard, Briefcase, Library, BarChart3, Menu, Users, LogOut, Building2, UserSearch, ClipboardList } from "lucide-react";
...
const APPS = [
  ...
  { id: "requisitions", label: "Requisitions", href: "/requisitions", icon: ClipboardList },
